...
export function Header() {
  ...
  return (
    <header data-app-navbar className="sticky top-0 z-40 bg-[#0f4c75] dark:bg-slate-900/95 backdrop-blur border-b border-[#0c3d5e] dark:border-slate-700 shadow-sm pt-[env(safe-area-inset-top)]">
